...
const Footer = () => {
  return (
    <footer className="bg-black text-white py-10 font-sans mt-auto w-full">
        ...
        <div className="text-center md:text-left">
          ...
          <div className="logo">
            <img
              ...
              alt="Logo"
              className="h-[100px] mb-4" // Logo size set to 100x100px on mobile
            />
          </div>
          {/* Social Media Icons */}
          <div className="ml-2 flex justify-center md:justify-start space-x-4 text-gray-400">
