...
function Navbar() {
  ...
  const nav3 = () => {
    navigate('/centres'); // Navigate to the Centres page
  };
  ...
  const nav5 = () => {
    navigate('/accessories'); // Navigate to the Accessories page
  };
  ...
  const handleButtonClick = (buttonName, index) => {
    ...
    // Navigation based on button clicked
    switch (buttonName) {
      case 'Home':
        nav1();
        break;
  ...
  useEffect(() => {
    switch (location.pathname) {
      ...
      case '/services':
        ...
        break;
      case '/centres':
        setActiveButton('Centres');
        break;
      case '/partnership':
        setActiveButton('Partnership');
        break;
      case '/accessories':
  ...
  return (
    <div className="navbar bangers-regular bg-black text-white">
      ...
      <header className="hidden lg:flex justify-between items-center container mx-auto max-w-full py-4">
        ...
        <div className="logo">
          <img
            onClick={nav1}  // Navigate to homepage when logo is clicked
        ...
        <div className="middle-buttons nav-links flex justify-center w-[600px] h-[50px] flex-shrink-0 border-2 border-white rounded-full bg-[#ebe9e9] bg-opacity-20">
          {["Home", "Services", "Centres", "Partnership", "Accessories"].map((buttonName, index) => (
            <button
              ...
              onClick={() => handleButtonClick(buttonName, index)} // Handle button click to navigate
            >
              {buttonName}
            </button>
          ))}
