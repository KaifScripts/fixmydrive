  ...
  return (
    <div className="bg-black min-h-screen flex flex-col items-center justify-center text-white">
      <div className="relative w-full">
        ...
        <div className="absolute flex justify-center items-center w-full h-[280px] top-[0px]">
          <div className="absolute w-[230px] h-[250px] bg-[#DF0907] rounded-full blur-3xl opacity-30"></div>
        </div>

        {/* Description Text Div */}
        <div className="text-center mb-8 px-4 md:px-8 mx-[100px]">
          <p className="font-dm-sans text-lg font-light">
            <span className="text-[#DF0907]">At</span> FixMyDrive, <span className="text-[#DF0907]">we bring</span> top-notch vehicle repair, maintenance, and inspection services <span className="text-[#DF0907]">directly to your</span> doorstep.<span className="text-[#DF0907]"> With a team of skilled technicians and a commitment to transparency and quality, we cater to all your vehicle needs, ensuring your car stays</span> road-ready and reliable.          </p>
        </div>

        {/* Heading */}
        <h1 className="text-3xl font-bold mt-[70px] mb-8 ban text-center relative z-10 mb-10">OUR SERVICES</h1>

      </div>

      <div className="font-dm-sans relative grid-container">
